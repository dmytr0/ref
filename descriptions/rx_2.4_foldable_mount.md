* Версія V1.0 - складається трошки вбік щоб антена не впиралась в верхню кришку рами. Для дронів в стопку підхоядть [спейсери середні 50mm](#fpv_stack_spacers)
